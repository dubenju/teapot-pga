...
public class AnalyzerJava_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "teapot.pga.AnalyzerJava"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AnalyzerJava_ESTest_scaffolding.class.getClassLoader() ,
      "teapot.pga.Options",
      "teapot.pga.Analyzer",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AnalyzerJava_ESTest_scaffolding.class.getClassLoader()); 
